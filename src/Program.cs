    ...
    public class Program
    {
        ...
        static async Task Main(string[] args)
        {
            try
            {
                 ...
                 _core.Information($"Waiting {ms} milliseconds..."); // debug is only output if you set teh secret ACTIONS_RUNNER_DEBUG to true

                 _core.Information(DateTime.Now.ToLongTimeString());
